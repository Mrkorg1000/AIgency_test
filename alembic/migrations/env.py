...
dotenv_path = os.path.join(project_root, 'common', '.env')

load_dotenv(dotenv_path)
print(f"DEBUG (env.py): project_root is: {project_root}")
print(f"DEBUG (env.py): dotenv_path is: {dotenv_path}")
print(f"DEBUG (env.py): Does gl.env exist at this path? {os.path.exists(dotenv_path)}")
